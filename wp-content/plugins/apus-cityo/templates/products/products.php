...
if ( $loop->have_posts() ) {
	$layout_type = apuscityo_get_config('listing_products_layout', 'grid');
	$columns = apuscityo_get_config('listing_products_columns', 1);
?>

	<div class="listing-products widget woocommerce">

		<h2><?php echo apuscityo_get_config('listing_products_title', 'Listing Products'); ?></h2>
