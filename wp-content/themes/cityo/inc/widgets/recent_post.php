...
class Cityo_Recent_Post extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_recent_post',
            esc_html__('Apus Recent Posts Widget', 'cityo'),
            array( 'description' => esc_html__( 'Show list of recent post', 'cityo' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('post_type')); ?>">
                <?php echo esc_html__('Type:', 'cityo' ); ?>
            </label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_post' )); ?>"><?php esc_html_e( 'Num Posts:', 'cityo' ); ?></label>
...
if ( function_exists('apus_framework_reg_widget') ) {
    apus_framework_reg_widget('Cityo_Recent_Post');
}