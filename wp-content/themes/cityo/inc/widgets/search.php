...
class Cityo_Search extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_search',
            esc_html__('Apus Search Widget', 'cityo'),
            array( 'description' => esc_html__( 'Show search form in sidebar', 'cityo' ), )
        );
...
if ( function_exists('apus_framework_reg_widget') ) {
    apus_framework_reg_widget('Cityo_Search');
}