...
if ( !class_exists("Cityo_Nav_Menu") ) {
    class Cityo_Nav_Menu extends Walker_Nav_Menu {
       ...
       /**
        ...
        public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            ...
            $item_output .= $args->has_children || $apus_mega_profile ? ' <b class="fas fa-angle-down"></b></a>' : '</a>';
