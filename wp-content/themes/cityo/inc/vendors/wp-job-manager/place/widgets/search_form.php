...
class Cityo_Elementor_Listings_Place_Search_Form extends Elementor\Widget_Base {

	public function get_name() {
        return 'cityo_listings_place_search_form';
    }
...
Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Cityo_Elementor_Listings_Place_Search_Form );