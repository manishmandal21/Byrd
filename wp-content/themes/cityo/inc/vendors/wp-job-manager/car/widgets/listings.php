...
class Cityo_Elementor_Car_Listings extends Elementor\Widget_Base {

	public function get_name() {
        return 'cityo_car_listings';
    }
...
Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Cityo_Elementor_Car_Listings );