...
class Cityo_Elementor_Listings_Real_Estate_Search_Form extends Elementor\Widget_Base {

	public function get_name() {
        return 'cityo_listings_real_estate_search_form';
    }
	...
	protected function _register_controls() {
        ...
        if ( cityo_get_config('listing_filter_show_contract') ) {
            $this->add_control(
                'search_contract',
                [
                    'label' => esc_html__( 'Show Search Contract', 'cityo' ),
                    'type' => Elementor\Controls_Manager::SWITCHER,
                    'default' => '',
                    'label_on' => esc_html__( 'Hide', 'cityo' ),
                    'label_off' => esc_html__( 'Show', 'cityo' ),
        ...
        if ( cityo_get_config('listing_filter_show_types') ) {
            $this->add_control(
                'search_type',
                [
                    'label' => esc_html__( 'Show Search Type', 'cityo' ),
                    'type' => Elementor\Controls_Manager::SWITCHER,
                    'default' => '',
                    'label_on' => esc_html__( 'Hide', 'cityo' ),
                    'label_off' => esc_html__( 'Show', 'cityo' ),
	...
	protected function render() {
        ...
        <div class="widget-listingsearch listingsearch-vertical <?php echo esc_attr($el_class); ?>">
            <?php get_job_manager_template( 'job-filters-simple-real-estate.php', $settings ); ?>
        </div>
        <?php
...
Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Cityo_Elementor_Listings_Real_Estate_Search_Form );