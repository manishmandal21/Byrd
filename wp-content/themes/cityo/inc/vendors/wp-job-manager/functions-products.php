...
class Cityo_Products {

	public static function init() {
        // Add products field to submit form
        add_filter( 'apuscityo-types-render_field', array( __CLASS__, 'form_fields' ), 10, 5 );
	}
    ...
    public static function form_fields($field, $field_data, $fieldkey, $fieldtype, $priority) {
        ...
        $products = get_posts( apply_filters( 'cityo_products_field_form_args', $args ) );
