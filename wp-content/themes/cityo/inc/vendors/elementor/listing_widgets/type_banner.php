...
class Cityo_Elementor_Listings_Type_Banner extends Elementor\Widget_Base {

	public function get_name() {
        return 'cityo_listings_type_banner';
    }

	public function get_title() {
        return esc_html__( 'Apus Listings Type Banner', 'cityo' );
    }
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            'slug',
            [
                'label' => esc_html__( 'Type Slug', 'cityo' ),
                'type' => Elementor\Controls_Manager::TEXT,
                'placeholder' => esc_html__( 'Enter your Type Slug here', 'cityo' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'name' => 'image',
                'label' => esc_html__( 'Type Image', 'cityo' ),
        ...
        $this->add_control(
            'icon',
            [
                'label' => esc_html__( 'Type Icon', 'cityo' ),
	...
	protected function render() {
        ...
        <div class="widget-listing-category-banner <?php echo esc_attr($el_class); ?>">
            ...
            ?>
                ...
                ?>
                <a href="<?php echo esc_url(get_term_link( $term, 'job_listing_type' )); ?>" class="<?php echo esc_attr($layout_type); ?>">
...
Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Cityo_Elementor_Listings_Type_Banner );