...
class Ogami_Elementor_Team extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Teams', 'cityo' );
    }
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            'name', [
                'label' => esc_html__( 'Member Name', 'cityo' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Member Name' , 'cityo' ),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'job', [
                'label' => esc_html__( 'Member Job', 'cityo' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Member Job' , 'cityo' ),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'description', [
                'label' => esc_html__( 'Member Description', 'cityo' ),
                'type' => Controls_Manager::TEXTAREA,
                'default' => esc_html__( 'Member Description' , 'cityo' ),
                'label_block' => true,
            ]
        );
