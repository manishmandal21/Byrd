...
class Cityo_Elementor_Banner extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Banner', 'cityo' );
    }
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                'name' => 'image',
                'label' => esc_html__( 'Image Background', 'cityo' ),
                'type' => Controls_Manager::MEDIA,
                'placeholder'   => esc_html__( 'Upload Image Background Here', 'cityo' ),
            ]
        );
        $this->add_control(
            'img_src',
        ...
        $this->add_responsive_control(
            'img_align',
            [
                'label' => esc_html__( 'Image Alignment', 'cityo' ),
        ...
        $this->add_responsive_control(
            'content_align',
            [
                'label' => esc_html__( 'Content Alignment', 'cityo' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => esc_html__( 'Left', 'cityo' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'style3' => esc_html__('Style 3', 'cityo'),
                    'style4' => esc_html__('Style 4', 'cityo'),
                ),
                'default' => 'style1'
            ]
        );
        $this->add_control(
            'vertical',
            [
                'label' => esc_html__( 'Vertical Content', 'cityo' ),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'flex-top' => esc_html__('Top', 'cityo'),
                    'flex-middle' => esc_html__('Middle', 'cityo'),
                    'flex-bottom' => esc_html__('Bottom', 'cityo'),
                ),
                'default' => 'flex-middle'
            ]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new Cityo_Elementor_Banner );