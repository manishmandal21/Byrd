...
class Cityo_Elementor_Features_Box extends Widget_Base {

    public function get_name() {
        return 'cityo_features_box';
    }

    public function get_title() {
        return esc_html__( 'Apus Features Box', 'cityo' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Features Box', 'cityo' ),
        ...
        $repeater->add_control(
            'image_icon',
            [
                'label' => esc_html__( 'Image or Icon', 'cityo' ),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'icon' => esc_html__('Icon', 'cityo'),
                    'image' => esc_html__('Image', 'cityo'),
                ),
                'default' => 'image'
            ]
        );
        ...
        $repeater->add_control(
            'title_text',
            [
                'label' => esc_html__( 'Title & Description', 'cityo' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'This is the heading', 'cityo' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'cityo' ),
                'placeholder' => esc_html__( 'Enter your description', 'cityo' ),
                'separator' => 'none',
                'rows' => 10,
                'show_label' => false,
            ]
        ...
        $this->add_control(
            'icon_color',
            [
                'label' => esc_html__( 'Icon Color', 'cityo' ),
        ...
        if ( !empty($features) ) {
            ...
            <div class="widget-features-box <?php echo esc_attr($el_class.' '.$alignment.' '.$style); ?>">
                <?php if($layout == 'carousel') {?>
                    <div class="slick-carousel pagination_white <?php echo esc_attr( count($features) == $columns ) ? 'hidden-dots':''; ?>" data-items="<?php echo esc_attr($columns); ?>" data-smallmedium="3" data-extrasmall="3" data-smallest="2" data-pagination="true" data-nav="false">
...
Plugin::instance()->widgets_manager->register_widget_type( new Cityo_Elementor_Features_Box );