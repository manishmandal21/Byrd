...
<head>
	...
	if ( !function_exists( 'wp_site_icon' ) ) {
		$favicon = cityo_get_config('media-favicon');
...
<body <?php body_class(); ?>>
<?php if ( cityo_get_config('preload', true) ) {
	$preload_icon = cityo_get_config('media-preload-icon');
...
<div id="wrapper-container" class="wrapper-container">
	...
	<?php
		...
		if ( !empty($header) ) {
			cityo_display_header_builder($header);
		} else {
