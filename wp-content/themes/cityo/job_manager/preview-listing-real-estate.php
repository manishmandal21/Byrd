...
?>
<div class="quickview-wrapper job_listing quickview-real-estate job-grid-style job-grid-real-estate" <?php echo trim(cityo_display_map_data($post)); ?>>
			...
			<div class="preview-content-wrapper">
				<div class="preview-content-inner">
					...
					<div class="listing-image">
						...
						<?php do_action( 'cityo-listings-preview-real-estate-flags', $post ); ?>
					</div>

					<div class="bottom-grid">
						<div class="listing-content clearfix">
							<?php do_action( 'cityo-listings-preview-real-estate-logo', $post ); ?>
							<div class="listing-content-inner">
								<?php do_action( 'cityo-listings-preview-real-estate-title-above', $post ); ?>
								<h3 class="listing-title"><a href="<?php echo esc_url(get_permalink($post_id)); ?>"><?php echo get_the_title($post_id); ?></a></h3>
								<?php do_action( 'cityo-listings-preview-real-estate-title-below', $post ); ?>
							</div>
						</div>
						<div class="listing-content-bottom flex-middle clearfix">
							<?php do_action( 'cityo-listings-preview-real-estate-metas', $post ); ?>
						</div>
					</div>
