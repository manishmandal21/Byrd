	...
	<div class="search_jobs clearfix search_jobs--frontpage">
		...
		<div class="inner-left">
			<div class="flex-middle row-20">
		        ...
		        <?php if ( !empty($show_search_date) && $show_search_date && cityo_get_config('listing_filter_show_date') ) { ?>
			        ...
			        <div class="search_date_from  search-filter-wrapper">
			        	<input class="search-field" autocomplete="off" type="text" name="filter_event_date_from" placeholder="<?php esc_attr_e( 'Start Date...', 'cityo' ); ?>" value="<?php echo esc_attr( $date_from ); ?>"/>
			        </div>

			        <div class="search_date_from  search-filter-wrapper">
			        	<input class="search-field" autocomplete="off" type="text" name="filter_event_date_to" placeholder="<?php esc_attr_e( 'Finish Date...', 'cityo' ); ?>" value="<?php echo esc_attr( $date_to ); ?>"/>
			        </div>
		        <?php } ?>
