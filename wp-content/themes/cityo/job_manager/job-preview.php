...
if ( $form->get_job_id() ) {
	...
	<form method="post" id="job_preview" action="<?php echo esc_url( $form->get_action() ); ?>">
		...
		<div class="job_listing_preview_title">
			<input type="submit" name="continue" id="job_preview_submit_button" class="button job-manager-button-submit-listing btn btn-danger btn-sm" value="<?php echo apply_filters( 'submit_job_step_preview_submit_text', esc_html__( 'Submit Listing', 'cityo' ) ); ?>"/>
			<input type="submit" name="edit_job" class="button job-manager-button-edit-listing btn btn-theme btn-sm" value="<?php esc_html_e( 'Edit listing', 'cityo' ); ?>"/>
	...
	<?php
		global $cityo_preview;
		$cityo_preview = 'preview';
