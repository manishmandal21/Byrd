...
global $apus_author;
$posts_per_page = cityo_get_config('user_profile_bookmark_number', 25);
...
if ( empty($ids) ) {
	...
	<div id="job-manager-job-dashboard">
		<div class="job-manager-jobs clearfix">
			...
			<?php esc_html_e( 'You do not have any listings bookmark.', 'cityo' ); ?>
			</div>
		</div>
	</div>
	<?php
...
<div id="job-manager-job-dashboard">
	<div class="job-manager-jobs clearfix box-user">
		<?php if ( ! $jobs ) : ?>
			<div class="text-warning">
				<?php esc_html_e( 'You do not have any listings bookmark.', 'cityo' ); ?>
			</div>
