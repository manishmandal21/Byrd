...
<?php if ( ! empty( $author_email ) ) : ?>
    <h4 class="contact-form-title"><?php echo esc_html__( 'Contact Form', 'cityo' ); ?></h4>
    <div class="inner-content">
        <form method="post" action="?">
            <div class="form-group">
                <input type="text" class="form-control style2" name="subject" placeholder="<?php esc_attr_e( 'Subject', 'cityo' ); ?>">
            </div><!-- /.form-group -->

            <div class="form-group">
                <input type="email" class="form-control style2" name="email" placeholder="<?php esc_attr_e( 'E-mail', 'cityo' ); ?>">
            </div><!-- /.form-group -->

            <div class="form-group space-30">
                <textarea class="form-control style2" name="message" placeholder="<?php esc_attr_e( 'Message', 'cityo' ); ?>"></textarea>
            </div><!-- /.form-group -->
            ...
            <button class="button btn btn-block btn-theme" name="contact-form"><?php echo esc_html__( 'Send Message', 'cityo' ); ?></button>
        </form>
    </div>
<?php endif; ?>