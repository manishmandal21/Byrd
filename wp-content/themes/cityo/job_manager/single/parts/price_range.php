...
<div id="listing-price_range" class="listing-price_range widget">
	<h2 class="widget-title">
		<span><?php esc_html_e('Price Range', 'cityo'); ?></span>
	</h2>
	<div class="inner">
		<?php
		...
		?>
		<span class="highlight"> <?php echo esc_html_e('Price Range', 'cityo'); ?></span>
		<?php
		cityo_display_price_range($post);
		?>

		<?php do_action('cityo-single-listing-price-range', $post); ?>
	</div>
</div>
<?php }