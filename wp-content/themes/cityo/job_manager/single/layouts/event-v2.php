<article id="post-<?php the_ID(); ?>" <?php post_class('detail-listing-event detail-listing-event-v2 apus-single-listing-wrapper'); ?> <?php echo trim(cityo_display_map_data($post)); ?>>
