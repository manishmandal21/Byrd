<article id="post-<?php the_ID(); ?>" <?php post_class('detail-listing-place detail-listing-place-v1 apus-single-listing-wrapper'); ?> <?php echo trim(cityo_display_map_data($post)); ?>>
	<?php
	global $post;
