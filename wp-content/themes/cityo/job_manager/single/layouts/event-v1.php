<article id="post-<?php the_ID(); ?>" <?php post_class('detail-listing-event detail-listing-event-v1 apus-single-listing-wrapper'); ?> <?php echo trim(cityo_display_map_data($post)); ?>>
	<?php
	global $post;
	...
	<div class="header-gallery-wrapper header-top-job style-white" <?php echo trim($style); ?>>
		<?php get_template_part( 'job_manager/single/parts/header-event' ); ?>
	</div>
	<?php
