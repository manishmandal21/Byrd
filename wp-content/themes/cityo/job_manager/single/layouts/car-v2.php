<article id="post-<?php the_ID(); ?>" <?php post_class('detail-listing-car detail-listing-car-v2 apus-single-listing-wrapper'); ?> <?php echo trim(cityo_display_map_data($post)); ?>>
