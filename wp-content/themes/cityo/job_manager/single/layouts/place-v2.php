<article id="post-<?php the_ID(); ?>" <?php post_class('detail-listing-place detail-listing-place-v2 apus-single-listing-wrapper'); ?> <?php echo trim(cityo_display_map_data($post)); ?>>
	<div class="header-gallery-wrapper header-top-job">
		<?php get_template_part( 'job_manager/single/parts/gallery' ); ?>
		<?php get_template_part( 'job_manager/single/parts/header-place' ); ?>
	</div>
	<?php
