...
<ul class="job-listing-meta meta">
	...
	<li class="date-posted" itemprop="datePosted"><date><i class="far fa-clock"></i><?php printf( esc_html__( 'Posted %s ago', 'cityo' ), human_time_diff( get_post_time( 'U' ), current_time( 'timestamp' ) ) ); ?></date></li>
