...
if ( $field['taxonomy'] == 'job_listing_amenity' && $apus_cityo_listing_type !== 'car' ) {
	$terms = array();
...
if ( !$display_warning ) {
	...
	Cityo_Submittion::job_manager_dropdown_categories( apply_filters( 'job_manager_term_multiselect_field_args', $args ) );
} else {
	?>
	<div class="alert alert-warning"><?php esc_html_e('Please choose category to display available features', 'cityo'); ?></div>
	<?php
}
