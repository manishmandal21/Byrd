	...
	<div class="form-group group-upload">
        <div class="upload-file-btn">
            ...
            <?php if ( ! empty( $field['multiple'] ) ) {
            	?>
            	<span><?php esc_html_e('Add Images', 'cityo'); ?></span>
            	<?php
            } else {
            	?>
            	<span><?php esc_html_e('Add Image', 'cityo'); ?></span>
            	<?php
            } ?>
...
<small class="description">
	...
	<?php else : ?>
		<?php printf( esc_html__( 'Maximum file size: %s.', 'cityo' ), size_format( wp_max_upload_size() ) ); ?>
	<?php endif; ?>
</small>