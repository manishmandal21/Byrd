...
<div class="regions-field <?php echo esc_attr( is_admin() ? 'is-admin' : ''); ?>">
	<?php
	    ...
	    $region1_text = cityo_get_config('submit_listing_region_1_field_label');
    ?>
	    <div class="field-region field-region1">
	    	<label><?php echo trim($region1_text); ?></label>
		    <select class="select-field-region select-field-region1" data-next="2" autocomplete="off" name="<?php echo isset( $field['name'] ) ? $field['name'] : $key; ?>[]" data-placeholder="<?php echo sprintf(esc_attr__('Please select %s', 'cityo'), $region1_text); ?>">
		    	<option value=""><?php echo sprintf(esc_html__('Please select %s', 'cityo'), $region1_text); ?></option>
			    <?php
    ...
    <?php if ( $nb_fields == '2' || $nb_fields == '3' || $nb_fields == '4' ) {
    	$region2_text = cityo_get_config('submit_listing_region_2_field_label');
	?>
	    <div class="field-region field-region2">
	    	<label><?php echo trim($region2_text); ?></label>
	    	<select class="select-field-region select-field-region2" data-next="3" autocomplete="off" name="<?php echo isset( $field['name'] ) ? $field['name'] : $key; ?>[]" data-placeholder="<?php echo sprintf(esc_attr__('Please select %s', 'cityo'), $region2_text); ?>">
	    		<option value=""><?php echo sprintf(esc_html__('Please select %s', 'cityo'), $region2_text); ?></option>
	    		<?php
    ...
    <?php if ( $nb_fields == '3' || $nb_fields == '4' ) {
    	$region3_text = cityo_get_config('submit_listing_region_3_field_label');
	?>
    	<div class="field-region field-region3">
    		<label><?php echo trim($region3_text); ?></label>
	    	<select class="select-field-region select-field-region3" data-next="4" autocomplete="off" name="<?php echo isset( $field['name'] ) ? $field['name'] : $key; ?>[]" data-placeholder="<?php echo sprintf(esc_attr__('Please select %s', 'cityo'), $region3_text); ?>">
	    		<option value=""><?php echo sprintf(esc_html__('Please select %s', 'cityo'), $region3_text); ?></option>
	    		<?php
    ...
    <?php } ?>
    <?php if ( $nb_fields == '4' ) {
    	$region4_text = cityo_get_config('submit_listing_region_4_field_label');
	?>
	    <div class="field-region field-region4">
	    	<label><?php echo trim($region4_text); ?></label>
	    	<select class="select-field-region select-field-region4" data-next="5" autocomplete="off" name="<?php echo isset( $field['name'] ) ? $field['name'] : $key; ?>[]" data-placeholder="<?php echo sprintf(esc_attr__('Please select %s', 'cityo'), $region4_text); ?>">
	    		<option value=""><?php echo sprintf(esc_html__('Please select %s', 'cityo'), $region4_text); ?></option>
	    		<?php
