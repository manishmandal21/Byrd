...
?>
<div class="quickview-wrapper job_listing quickview-place job-grid-style job-grid-place" <?php echo trim(cityo_display_map_data($post)); ?>>
			...
			<div class="preview-content-wrapper">
				<div class="preview-content-inner">
					...
					<div class="listing-image">
						...
						<?php do_action( 'cityo-listings-preview-place-flags', $post ); ?>
					</div>

					<div class="bottom-grid">
						<div class="listing-content flex-middle clearfix">
							<?php do_action( 'cityo-listings-preview-place-logo', $post ); ?>
							<div class="listing-content-inner">
								<?php do_action( 'cityo-listings-preview-place-title-above', $post ); ?>
								<h3 class="listing-title"><a href="<?php echo esc_url(get_permalink($post_id)); ?>"><?php echo get_the_title($post_id); ?></a></h3>
								<?php do_action( 'cityo-listings-preview-place-title-below', $post ); ?>
							</div>
						</div>
						<div class="listing-content-bottom flex-middle clearfix">
							<?php do_action( 'cityo-listings-preview-place-metas', $post ); ?>
						</div>
					</div>
