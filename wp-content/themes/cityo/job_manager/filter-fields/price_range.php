<?php
	$price_ranges = cityo_job_manager_price_range_icons();
...
<div class="search_price_range clearfix">
	...
	<select class="filter_price_range" data-placeholder="<?php esc_attr_e( 'Price Range', 'cityo' ); ?>" name="filter_price_range">
		<option value=""><?php esc_html_e( 'Price Range', 'cityo' ); ?></option>
