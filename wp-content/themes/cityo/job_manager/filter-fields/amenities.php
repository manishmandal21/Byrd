<div class="search_amenity_wrapper">
	<h4><?php esc_html_e('Filter by Features', 'cityo'); ?></h4>
	<div class="amenities-wrap">
		<?php
			...
			if ( $apus_cityo_listing_type !== 'car' && !empty($selected_category) && ($cat_term = get_term_by('term_id', $selected_category, 'job_listing_category')) ) {
				$args = array(
					'hierarchical' => 1,
					'hide_empty' => false,
					'meta_query' => array(
