<div class="search_location">
	...
	?>
	<input type="text" class="form-control style2" name="search_location" id="search_location<?php echo esc_attr(cityo_get_config('listing_filter_show_distance') ? '_distance' : ''); ?>" placeholder="<?php esc_attr_e('Location', 'cityo'); ?>" value="<?php echo esc_attr($search_location); ?>" autocomplete="off" />
