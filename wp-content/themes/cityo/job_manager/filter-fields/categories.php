...
<div class="select-categories <?php echo esc_attr($select_class); ?>">
	...
	<?php
	$placeholder = !empty($categories_label) ? $categories_label : esc_html__( 'Filter by category', 'cityo' );
	...
	?>
	<?php job_manager_dropdown_categories( array( 'taxonomy' => 'job_listing_category', 'hierarchical' => 1, 'show_option_all' => $placeholder, 'placeholder' => $placeholder, 'name' => 'search_categories', 'orderby' => 'name', 'multiple' => false, 'hide_empty'  => false, 'selected' => $selected_category ) ); ?>
