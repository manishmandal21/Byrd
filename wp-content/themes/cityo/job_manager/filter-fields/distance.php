...
$search_distance = isset( $_REQUEST['search_distance'] ) ? $_REQUEST['search_distance'] : cityo_get_config('listing_filter_distance_default', 50);
?>
<div class="search_distance_wrapper clearfix">
	<div class="search-distance-label">
		<label for="use_search_distance">
			<input name="use_search_distance" checked="checked" type="checkbox">
			<?php echo sprintf(wp_kses(__('Radius: <span class="text-distance">%s</span> %s', 'cityo'), array('span' => array('class' => array()))), $search_distance, $distance_type); ?>
		</label>
	</div>
