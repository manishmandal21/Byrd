...
<article <?php post_class('post list-default'); ?>>
    <div class="row list-inner flex-middle <?php echo (!empty($thumb) && $post_format != 'audio' && $post_format != 'video' && $post_format != 'gallery') ? 'has-thumb' : 'no-thumb'; ?>">
        <?php
            if ( !empty($thumb) && $post_format != 'audio' && $post_format != 'video' && $post_format != 'gallery' ) {
                ?>
        ...
        ?>
        <div class="col-xs-<?php echo esc_attr(!empty($thumb) ? '8' : '12'); ?> info">
          <div class="info-content">
            ...
            ?>
            <?php if ( has_excerpt() ) { ?>
                <div class="description"><?php echo cityo_substring( get_the_excerpt(), 35, '...' ); ?></div>
            <?php } ?>
          </div>
        </div>
    </div>
